...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (tide typescript-mode grip-mode dired-subtree company-anaconda flycheck-mypy pyimpsort importmagic pyimport anaconda-mode lua-mode htmlize exec-path-from-shell diminish spaceline spaceline-all-the-icons dired-quick-sort dsvn f elfeed purescript-mode magit yasnippet-snippets psc-ide clojure-snippets cider clojure-mode company-lsp company-nginx nginx-mode python-mode lsp-ui lsp-mode sbt-mode scala-mode yasnippet restclient projectile intero haskell-mode flycheck company markdown-mode yaml-mode which-key web-mode uuid use-package undo-tree solarized-theme smartparens shm psvn multiple-cursors json-mode javadoc-lookup hydra helm helm-swoop helm-projectile helm-descbinds helm-ag haskell-snippets expand-region company-restclient company-flx circadian auto-highlight-symbol aggressive-indent ace-window ace-jump-mode)))
